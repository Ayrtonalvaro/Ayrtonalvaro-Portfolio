      ...
      <div className=" text-start  ">
        ...
        <div className="flex justify-start mt-8 gap-10 text-3xl text-slate-400">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <i className="fa-brands fa-linkedin-in text-4xl text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-cyan-200 dark:from-dark dark:to-cyan-900  hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-br hover:from-slate-900 hover:to-purple-200 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110"></i>
          </a>
          ...
          <a
            ...
            rel="noreferrer"
          >
            <i className="fa-brands fa-instagram text-4xl  text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-cyan-200 dark:from-dark dark:to-cyan-900  hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-br hover:from-slate-900 hover:to-purple-200 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110"></i>
          </a>
        </div>
        <motion.div
          className="z-1"
